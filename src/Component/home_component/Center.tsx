...
export default function Center() {
  ...
  return (
    <div style={{ backgroundColor: 'rgba(58,60,77,255)', boxShadow: 'rgb(24 144 255 / 35%) 0px 2px 7px' }} className="flex flex-col col-span-4 bg-blue items-center gap-5 p-5 max-h-[700px] overflow-y-auto rounded-xl transition-transform hover:scale-105 max-lg:col-span-1 max-lg:row-span-2 max-lg:max-h-[950px] ">
      <div className="flex flex-row gap-7 w-11/12 justify-between">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white size-9 lucide lucide-user-round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>
        <input
      ...
      <div className="w-11/12 p-5">
        {filteredPosts?.map((post: any) => (
          <div key={post.post_id} style={{ backgroundColor: 'rgba(24,132,254,255)', boxShadow: 'rgb(24 144 255 / 35%) 0px 2px 7px' }} className="bg-darkblue mb-4 p-5 rounded-lg transition-transform hover:scale-105">
